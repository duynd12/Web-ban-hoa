...
class commonmodel extends database
{
    ...
    function sigin($name, $email, $pass, $phonenumber, $address)
    {
        $sql = "INSERT INTO user_account(name,email_account,pass_word,phone_number,address_user,create_at,active_status) VALUES ('$name','$email','$pass','$phonenumber','$address',current_time(),'Hoạt Động')";
        $query = $this->conn->prepare($sql);
