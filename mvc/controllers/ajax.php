    ...
    function details()
    {
        ...
        echo '
                <div class="col-sm-12 padding-right">
                    ...
                    <div class="product-details" style="min-height: 470px;margin-top: 50px;"><!--product-details-->
                        ...
                        <table class="table table-condensed">
                            <thead>
                                <tr class="cart_menu">
                                    ...
                                    <td class="quantity">Phí Vận Chuyển</td>
                ...
                echo '
                                    <tr>
                                        ...
                                        <td class="cart_quantity">' . $values["quantity"] . '</td>
                                         <td class="cart_shipping" style="font-size:18px">' . $a . '</td>
                                        <td class="cart_total" id = "">
                                            <p class="cart_total_price">' . number_format($values["unit_price"] + 35000, $decimals = 0, $dec_point = ",", $thousands_sep = ".") . 'đ</p>
                                        </td>
                                    </tr>
                                ';
            }
