<div class="">
    <div class="page-title">
        <div class="title_left">
            <h3><?= $data['title'] ?></h3>
            <a href="admin/showcategory&page=<?= $data["page"] ?>" class="btn btn-primary">Trở Về</a>
            <h3 class="text-success"><?= $data["mess"] ?></h3>
            <h3 class="text-danger"><?= $data["mess2"] ?></h3>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input id="name" type="text" onkeyup="removeAccents(this)" class="form-control" name="name" value="<?= $data["data"][0]["name"] ?>">
