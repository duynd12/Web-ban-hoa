...
<body>
	<div class="container text-center">
		<div class="logo-404">
			<a href="<?=base?>"><img src="public/client/images/home/logo.jpg" alt="" /></a>
		</div>
    ...
    <script src="public/client/js/jquery.public/client/js"></script>
	<script src="public/client/js/price-range.public/client/js"></script>
    <script src="public/client/js/jquery.scrollUp.min.public/client/js"></script>
	<script src="public/client/js/bootstrap.min.public/client/js"></script>
    <script src="public/client/js/jquery.prettyPhoto.public/client/js"></script>
