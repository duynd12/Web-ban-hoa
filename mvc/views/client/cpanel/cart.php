...
<body>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="info-order">
							...
							<input id = "name" name="order[name]" value="<?php if (isset($_SESSION["info"]["name"])) echo $_SESSION["info"]["name"]; ?>" class="order full-name" type="text" placeholder="Họ tên" required readonly>


							<label for="">Số điện thoại</label>
							<input id = "phone" name="order[phone]" value="<?php if (isset($_SESSION["info"]["phone"])) echo $_SESSION["info"]["phone"]; ?>" class="order phone-number" type="text" placeholder="Số Điện Thoại" required readonly>
    ...
    margin-left: 40px;" name="submit" class="btn btn-default update">Thanh Toán</button>
						</div>
					</div>
				</div>
			</div>
